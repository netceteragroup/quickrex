...
public class JavaFlag extends Flag {
  public static final Flag JDK_CANON_EQ = new JavaFlag(
  ...
  public static final Flag JDK_UNICODE_CASE = new JavaFlag(
  ...
  public static final Flag JDK_DOTALL = new JavaFlag(
  ...
  public static final Flag JDK_MULTILINE = new JavaFlag(
  ...
  public static final Flag JDK_COMMENTS = new JavaFlag(
  ...
  public static final Flag JDK_CASE_INSENSITIVE = new JavaFlag(
